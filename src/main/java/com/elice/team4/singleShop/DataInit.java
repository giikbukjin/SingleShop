...
public class DataInit {
    ...
    public void init() {
        ...
        productRepository.save(new Product("옛날 떡볶이 300g", 1L, "탱글탱글한 떡과 부산어묵의 만남", "칼과 가위 필요 없이 초간단 조리가 가능한 모티의 옛날 떡볶이입니다. 맵지 않고 매콤달콤한 분식집 떡볶이로 아이들도 잘 먹어요.", "/images/img.png", 100, 2500));
